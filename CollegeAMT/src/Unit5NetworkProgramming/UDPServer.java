...
public class UDPServer {
    public static void main(String[] args) {
        ...
        try{
            DatagramSocket sc=new DatagramSocket(1111);
            ...
            while(true){
                ...
                //exit serve if out is received
                if(data(rcv).toString().equals("out")){
                    System.out.println("clinet sent out so exiting server");
                    break;
                }
                //clearing buffer
                rcv=new byte[6000];
    ...
    //cnmverting byte array to string 
